...
public class FragmentPerfilVendedor extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        deleteProductPrincipalButton = (Button) view.findViewById(R.id.buttonDeleteProduct);
        ...
        deleteProductPrincipalButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder selectProductsAlert = new AlertDialog.Builder(getContext());
                ...
                selectProductsAlert.setPositiveButton("Eliminar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        AlertDialog.Builder productsAlertDialog = new AlertDialog.Builder(getContext());
                        //We set the tittle we want for our alert dialog, in our case a message to ask a question to the user
